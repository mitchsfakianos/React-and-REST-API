              ...
              <form>
                  <div class="main--flex">
                      <div>
                          ...
                          <input id="courseTitle" name="courseTitle" type="text" value={this.state.course.title} />

                          <p>By Joe Smith</p>

                          <label for="courseDescription">Course Description</label>
                          <textarea id="courseDescription" name="courseDescription" value={this.state.course.description} />
                      </div>
                      <div>
                          <label for="estimatedTime">Estimated Time</label>
                          <input id="estimatedTime" name="estimatedTime" type="text" value={this.state.course.estimatedTime} />
